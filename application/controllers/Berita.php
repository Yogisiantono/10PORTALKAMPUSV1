...
class Berita extends CI_Controller {
	public function index(){
		...
		$this->template->load('loko-kampus/template','loko-kampus/view_semua_berita',$data);
	}
	...
	public function detail(){
		...
		$this->template->load('loko-kampus/template','loko-kampus/view_berita',$data);
	}
	...
	public function kategori(){
		...
		$data['description'] = description();
		$data['keywords'] = keywords();
		$this->template->load('loko-kampus/template','loko-kampus/view_kategori',$data);
	}
}
