...
class Playlist extends CI_Controller {
	public function index(){
			...
			$this->template->load('loko-kampus/template','loko-kampus/playlist',$data);
	}
	...
	public function detail(){
		...
		if ($query->num_rows()<=0){
			...
			$this->pagination->initialize($config);
			$this->template->load('loko-kampus/template','loko-kampus/detailplaylist',$data);
		}
	}
	...
	public function watch(){
		...
		if ($query->num_rows()<=0){
			...
			$this->template->load('loko-kampus/template','loko-kampus/play',$data);
		}
	}
